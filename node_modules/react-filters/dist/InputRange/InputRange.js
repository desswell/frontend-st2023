...
var InputRange = function (_Component) {
  ...
  function InputRange(props) {
    ...
    (0, _autoBind2.default)(['onSelect'], _this);
    return _this;
  }

  _createClass(InputRange, [{
    key: 'onSelect',
    value: function onSelect(name, selected) {
    ...
    value: function render() {
      ...
      var mainClass = (0, _classnames2.default)('react-filters', 'rf-input-range', name, { disabled: disabled });
...
InputRange.propTypes = {
  ...
  placeholders: _react.PropTypes.arrayOf(_react.PropTypes.string),
